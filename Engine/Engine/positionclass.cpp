...
void PositionClass::MouseHorizontal(int change)
{
	...
	m_horizontalSpeed = m_frameTime * change * horizSensitivity;

	if (m_horizontalSpeed > (m_frameTime * 0.15f)) 
	{
		m_horizontalSpeed = m_frameTime * 0.15f;
	}
	if (m_horizontalSpeed < -(m_frameTime * 0.15f)) 
	{
		m_horizontalSpeed = -m_frameTime * 0.15f;
...
void PositionClass::MouseVertical(int change)
{
	...
	m_verticalSpeed = m_frameTime * change * vertSensitvity;

	if (m_verticalSpeed > (m_frameTime * 0.15f)) 
	{
		m_verticalSpeed = m_frameTime * 0.15f;
	}
