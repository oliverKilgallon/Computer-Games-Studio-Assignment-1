...
bool BumpModelClass::Initialize(ID3D11Device* device, ModelType* modelType, WCHAR* textureFilename1, WCHAR* textureFilename2, int vertexCount, int indexCount) 
{
	bool result;

	this->m_model = modelType;
